...
import com.todo.app.todoappcompose.domain.usecase.CreateTaskUseCase
...
import com.todo.app.todoappcompose.ui.util.Constants
...
class EditViewModel @Inject constructor(
    ...
    private suspend fun getTask(id: String): Task {
        return when (val result = getTaskUseCase.execute(id)) {
